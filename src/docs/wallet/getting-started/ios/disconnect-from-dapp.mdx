...
The following example extends the code presented in the [Connect to a dApp](connect-to-dapp#example-code) guide. The example class listens for incoming requests from a dApp, waits 1s and cancels connection.
...
class BeaconExample {
    ...
    let dApp = Beacon.P2PPeer(
        ...
        relayServer: "beacon-node-1.octez.io" /* TODO: change me */,
