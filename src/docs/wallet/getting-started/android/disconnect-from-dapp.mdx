...
The following example extends the code presented in the [Connect to a dApp](connect-to-dapp#example-code) guide. The `Activity` listens for incoming requests from a dApp, waits 1s and cancels connection.
...
class MainActivity : AppCompatActivity() {
    ...
    val dApp = P2pPeer(
        ...
        "beacon-node-1.octez.io" /* TODO: change me */,
        "2" /* TODO: change me */,
    )
