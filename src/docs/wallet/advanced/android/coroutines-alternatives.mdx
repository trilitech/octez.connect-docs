...
octez.connect Android SDK by default uses [Coroutines](https://kotlinlang.org/docs/coroutines-overview.html) to handle asynchronous code. If you don't want to use [Coroutines](https://kotlinlang.org/docs/coroutines-overview.html) in your application, see the alternatives below.

## `:client-wallet-compat`

octez.connect Adndroid SDK ships with `:client-wallet-compat` module that provides a supplementary callback-based interface for `:client-wallet`. See the snippets below to learn how to use it.
...
See the guides below to learn how to integrate octez.connect Android SDK with other asynchronous libraries.
