...
octez.connect provides developers the ability to subscribe to its internal state, as shown on the dedicated page. Since version 4.2.0, subscribing to `ACTIVE_ACCOUNT_SET` has become mandatory. This page provides a custom example with user validation by requesting the wallet to sign a payload.
...
<Tabs
  groupId="octezConnectOrOctezJsSAAE1"
...
<Tabs
  groupId="octezConnectOrOctezJsSAAE2"
  defaultValue="octez-connect"
  values={[
    { label: "octez.connect", value: "octez-connect" },
    { label: "octez.js", value: "octez-js" },
...
While the example above works for single-page dApps, it may become problematic in a multi-tab setup. octez.connect emits an event to keep each tab synced with the internal state. Therefore, if your dApp needs multiple tabs support, the above approach may cause issues. Each tab will send a **sign_payload** request to the wallet, which is not intended and may lead to request rejection if a certain threshold is reached.
...
<Tabs
  groupId="octezConnectOrOctezJsSAAE3"
  defaultValue="npm"
  values={[
    { label: "NPM", value: "npm" },
...
<Tabs
  groupId="octezConnectOrOctezJsSAAE4"
  defaultValue="octez-connect"
  values={[
    { label: "octez.connect", value: "octez-connect" },
    { label: "octez.js", value: "octez-js" },
...
<Tabs
  groupId="octezConnectOrOctezJsSAAE5"
  defaultValue="octez-connect"
  values={[
    { label: "octez.connect", value: "octez-connect" },
    { label: "octez.js", value: "octez-js" },
...
```ts
import { DAppClient, BeaconEvent } from "@tezos-x/octez.connect-dapp";
