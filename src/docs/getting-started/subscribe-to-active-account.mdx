...
<Tabs
  groupId="octezConnectOrTaquitoSAAE1"
...
<Tabs
  groupId="octezConnectOrTaquitoSAAE2"
  defaultValue="octez.connect"
  values={[
    { label: "octez.connect", value: "octez.connect" },
    { label: "taquito", value: "taquito" },
...
<Tabs
  groupId="octezConnectOrTaquitoSAAE3"
  defaultValue="npm"
  values={[
    { label: "NPM", value: "npm" },
...
<Tabs
  groupId="octezConnectOrTaquitoSAAE4"
  defaultValue="octez.connect"
  values={[
    { label: "octez.connect", value: "octez.connect" },
    { label: "taquito", value: "taquito" },
...
<Tabs
  groupId="octezConnectOrTaquitoSAAE5"
  defaultValue="octez.connect"
  values={[
    { label: "octez.connect", value: "octez.connect" },
    { label: "taquito", value: "taquito" },
