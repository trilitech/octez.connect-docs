...
<Tabs
  groupId="octezConnectOrTaquito1"
...
<Tabs
  groupId="octezConnectOrTaquito2"
  defaultValue="octez.connect"
  values={[
    { label: "octez.connect", value: "octez.connect" },
    { label: "taquito", value: "taquito" },
...
<Tabs
  groupId="octezConnectOrTaquito3"
  defaultValue="octez.connect"
  values={[
    { label: "octez.connect", value: "octez.connect" },
    { label: "taquito", value: "taquito" },
...
<Tabs
  groupId="octezConnectOrTaquito6"
  defaultValue="octez.connect"
  values={[
    { label: "octez.connect", value: "octez.connect" },
    { label: "taquito", value: "taquito" },
...
<Tabs
  groupId="octezConnectOrTaquito7"
  defaultValue="octez.connect"
  values={[
    { label: "octez.connect", value: "octez.connect" },
    { label: "taquito", value: "taquito" },
