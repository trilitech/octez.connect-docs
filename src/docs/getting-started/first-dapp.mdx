...
<Tabs
  groupId="octezConnectOrOctezJs1"
...
```bash
npm install --save @tezos-x/octez.js @tezos-x/octez.js-dapp-wallet
```
...
You can then import the `octez.connect-sdk` package and create a `DAppClient` instance. This instance will be used throughout your dApp to interact with the users wallet.
Once created, you can send a permission request to prompt the user to connect to his wallet.

<Tabs
  groupId="octezConnectOrOctezJs2"
  defaultValue="octez-connect"
  values={[
    { label: "octez.connect", value: "octez-connect" },
    { label: "octez.js", value: "octez-js" },
...
<Tabs
  groupId="octezConnectOrOctezJs3"
  defaultValue="octez-connect"
  values={[
    { label: "octez.connect", value: "octez-connect" },
    { label: "octez.js", value: "octez-js" },
...
The `octez.connect` SDK is now fully set up and ready to receive operation requests.
...
<Tabs
  groupId="octezConnectOrOctezJs6"
  defaultValue="octez-connect"
  values={[
    { label: "octez.connect", value: "octez-connect" },
    { label: "octez.js", value: "octez-js" },
...
The destroy function is used to clean up resources and remove all octez.connect-sdk values from storage.

Once this function is executed, the current instance of `dAppClient` becomes unusable.

<Tabs
  groupId="octezConnectOrOctezJs7"
  defaultValue="octez-connect"
  values={[
    { label: "octez.connect", value: "octez-connect" },
    { label: "octez.js", value: "octez-js" },
...
Take a look a the [best practice](/getting-started/best-practices) for recommendations on octez.connect user interface components.
