...
[octez.connect Debug Wallet](https://debug.walletbeacon.io)
...
## octez.connect Accounts

It is possible to pair any octez.connect-compatible wallet to the Debug Wallet. If you do that, the Debug Wallet acts as a "relay" between the dApp and the actual wallet. Requests and responses will be relayed, but the details can be inspected.
