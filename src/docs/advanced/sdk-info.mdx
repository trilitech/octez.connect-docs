...
The following page lists all the different options in octez.connect to retrieve and display information about the SDK.

<Tabs
  groupId="octezConnectOrTaquitoSI1"
...
<Tabs
  groupId="octezConnectOrTaquitoSI2"
  defaultValue="octez.connect"
  values={[
    { label: "octez.connect", value: "octez.connect" },
    { label: "taquito", value: "taquito" },
...
<Tabs
  groupId="octezConnectOrTaquitoSI3"
  defaultValue="octez.connect"
  values={[
    { label: "octez.connect", value: "octez.connect" },
    { label: "taquito", value: "taquito" },
