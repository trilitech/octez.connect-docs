...
The `Custom Block Explorer` feature in octez.connect SDK allows developers to integrate a block explorer of their choice into their dApp.
...
<Tabs
  groupId="octezConnectOrTaquitoCBE"
