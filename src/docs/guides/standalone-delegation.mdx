...
You can easily integrate octez.connect into your website, even if it's just a simple landing page or wordpress site.

Below is an example of a very simple page that adds a "delegate" button that establishes a octez.connect connection and then sends a delegation request to the wallet.
...
<html lang="en">
  <head>
    ...
    <title>octez.connect Delegation Example</title>
    <!--
      Make sure you replace "5.0.0-beta.5" with the latest version.
      https://www.srihash.org/
    -->
    <script
      src="https://unpkg.com/@tezos-x/octez.connect-sdk@5.0.0-beta.5/dist/walletbeacon.min.js"
      integrity="sha384-S8bqg66RSvO7IwLIHTgxha/bCa04ZCQ4iEi8JYw2M5eeYkR2jpiK4nv/ta4IdXqi"
      crossorigin="anonymous"
    ></script>
  </head>
  <body>
    octez.connect Delegation Example
