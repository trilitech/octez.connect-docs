...
When using octez.connect in corporate or enterprise environments, you may need to configure your firewall to allow communication with octez.connect nodes. This guide covers all the necessary firewall configurations and enterprise solutions.
...
1. Whitelist all octez.connect node domains listed above
...
1. Firewall access to octez.connect nodes
