...
In octez.connect, we have implemented a system to monitor the performance of requests made to the wallet. This system helps identifying issues related to wallet interactions. This document details the structure and purpose of the performance metrics feature.
...
It's crucial to note that if this initial request fails because of a Netwrok error, octez.connect will automatically disable all metrics collection to prevent any operational disruptions and reliability of the metrics collection process.
:::
