---
title: How to Contribute to octez.connect
slug: /guides/how-to-contribute
---

# How to Contribute to octez.connect

We welcome contributions from the community! Whether you're fixing bugs, adding features, improving documentation, or adding wallet support, this guide will help you get started with contributing to the octez.connect SDK ecosystem.

## Overview

The octez.connect SDK consists of multiple repositories:

- **[octez.connect](https://github.com/trilitech/octez.connect)** - The main TypeScript SDK for web developers
...
- **[octez.connect-docs](https://github.com/trilitech/octez.connect-docs)** - Documentation website
...
1. Navigate to the repository you want to contribute to (e.g., [octez.connect](https://github.com/trilitech/octez.connect))
...
git remote add upstream https://github.com/trilitech/octez.connect.git
...
### Main octez.connect SDK (TypeScript)
...
1. **Clone the Documentation Repository**
   ...
   ```bash
   git clone https://github.com/trilitech/octez.connect-docs.git
   cd octez.connect-docs
   ```
...
Adding your wallet to the octez.connect SDK ecosystem makes it discoverable by dApps and increases adoption. Here's how to add support for your wallet:

### 1. Implement octez.connect Support in Your Wallet
...
1. **Fork the octez.connect repository**
...
1. **Example dApps**: Use the examples in the octez.connect repository
2. **Real dApps**: Test with actual Tezos dApps that use octez.connect
...
- **Discord**: Join our [Discord server](https://discord.gg/tezos)
- **GitHub Issues**: Open an issue for bugs or feature requests
- **Telegram**: [Beacon Telegram group](https://t.me/+07JtW7XF3B0yM2E0)

Thank you for contributing to the octez.connect ecosystem! Your efforts help make Tezos more accessible to developers and users worldwide.
