...
The FA2 Transfer feature in the octez.connect SDK is designed for handling token transfers using the FA2 standard. FA2 is a multi-asset interface, enabling a wide range of token types and configurations, including fungible, non-fungible, and multi-asset tokens.

<Tabs
  groupId="octezConnectOrOctezJsFA2"
  defaultValue="octez.js"
  values={[
