...
In octez.connect SDK, various events are emitted to signal different states and actions in the application's lifecycle. <br />
...
<Tabs
  groupId="octezConnectOrTaquitoSTE"
