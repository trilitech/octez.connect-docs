...
The following example shows how to do a simple contract call with octez.connect.

:::tip
The `octez.connect` SDK itself does not do any type checking on the parameters you pass. Use taquito if you don't want to construct the parameters yourself.
:::
...
<Tabs
  groupId="octezConnectOrOctezJsSCC"
