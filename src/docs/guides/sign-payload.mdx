...
<Tabs
  groupId="octezConnectOrTaquitoSP1"
...
<Tabs
  groupId="octezConnectOrTaquitoSP2"
  defaultValue="octez.connect"
  values={[
    { label: "octez.connect", value: "octez.connect" },
    { label: "taquito", value: "taquito" },
...
:::warning
Not all wallets support the `RAW` signing type. Additionally, the signatures can be different depending on the wallet that was used. For the preferred way of signing arbitrary data, please check the docs here: https://taquito.io/docs/signing/#generating-a-signature-with-beacon-sdk
:::

<Tabs
  groupId="octezConnectOrTaquitoSP3"
  defaultValue="octez.connect"
  values={[
    { label: "octez.connect", value: "octez.connect" },
    { label: "taquito", value: "taquito" },
